...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { captial: @state.captial, name: @state.name, population: @state.population } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { captial: @state.captial, name: @state.name, population: @state.population } }
